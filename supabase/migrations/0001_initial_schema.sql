-- Roegusta Tour baseline Supabase schema migration.
-- This 0001 migration is for fresh database recreation from migrations.
-- Existing Supabase databases that already had this foundation schema applied manually
-- should not need to run this baseline again; they should only need later incremental
-- migrations such as 0002_tour_results_handbook.sql when the baseline tables exist.
