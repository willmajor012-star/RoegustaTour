...
const adminGuideSections: AdminGuideSection[] = [
  ...
  { id: 'guide-pairings', title: 'Pairings and tee times', summary: 'Create matches, assign sides/players, set tee times, and publish pairings.', blocks: [
    ...
    { heading: 'Troubleshooting', items: ['Golf page tabs are Tee Times, Results, Teams. If pairings do not show, check round Published, match Published, current public tour, and public password access.', 'If tee times show TBC, enter match tee times or apply sequential tee times and save.'] },
  ] },
