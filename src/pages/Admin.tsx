...
const adminGuideSections: AdminGuideSection[] = [
  ...
  { id: 'guide-tour', title: 'Creating or selecting a tour', summary: 'Create annual tours, select existing tours for editing, and control the current public tour.', blocks: [
    ...
    { heading: 'Public check', items: ['Back to app, open Overview, Golf, Tours, Stats, Bet Punto, and Info to confirm the correct current public tour is showing.', 'If the wrong tour is current public, public pages can show the wrong rosters, rounds, results, handbook, and Bet Punto markets.'] },
  ] },
  { id: 'guide-2026-format', title: '2026 format setup', summary: 'Use the 2026 helper and verify the generated rounds/prizes.', blocks: [
    ...
    { heading: 'Afterwards', items: ['Review warnings about extra rounds. Extra protected rounds are not removed automatically.', 'Check Overview counts, Golf tee-time/result tabs, and Info itinerary after saving.'] },
  ] },
  ...
  { id: 'guide-teams', title: 'Teams and rosters', summary: 'Build teams, attendance, captains, colours, and published rosters.', blocks: [
    ...
    { heading: 'Public check', items: ['Teams appear on Golf > Teams and related public team displays once teams and rosters are published.', 'If Golf > Teams says TBC, check attending players, team assignment, team publish flags, and current public tour.'] },
  ] },
