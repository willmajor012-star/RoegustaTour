...
const tabs = ['Overview', 'Tour setup', 'Player library', 'Squads & teams', 'Courses', 'Rounds & tee times', 'Matches & pairings', 'Result entry', 'Handbook', 'Admin guide', 'Settings', 'Bet Punto', 'Coming next'] as const;
...
const adminGuideSections: AdminGuideSection[] = [
  { id: 'guide-admin-access', title: 'Admin access', summary: 'Open Admin, sign in with the Admin PIN, understand Admin mode, and leave safely.', blocks: [
    { heading: 'What this is for', items: ['Use this when you need PIN-protected tour setup, roster, round, match, result, handbook, settings, or Bet Punto admin tools.'] },
    ...
    { heading: 'What should happen', items: ['Before sign-in, no admin write tools are shown.', 'After sign-in, the admin section tabs appear: Overview, Tour setup, Player library, Squads & teams, Courses, Rounds & tee times, Matches & pairings, Result entry, Handbook, Admin guide, Settings, Bet Punto, and Coming next.'] },
  ...
  { id: 'guide-tour', title: 'Creating or selecting a tour', summary: 'Create annual tours, select existing tours for editing, and control the current public tour.', blocks: [
    { heading: 'When to create/select', items: ['Create a new tour for a new year or materially separate event.', 'Select an existing tour when correcting rosters, results, handbook, or archive content for that tour.'] },
    ...
    { heading: 'Public check', items: ['Back to app, open Home, Golf, Tours, Stats and Bet Punto to confirm the correct current public tour is showing.', 'If the wrong tour is current public, public pages can show the wrong rosters, courses, rounds, results, handbook and Bet Punto markets.'] },
  ] },
  ...
  { id: 'guide-info', title: 'Info page / handbook / itinerary', summary: 'Maintain public Info page cards, itinerary rows, and handbook content.', blocks: [
    { heading: 'Differences', items: ['Rounds are golf sessions used by Golf/results/scoring.', 'Itinerary items are schedule rows shown on Info and are stored in tour_itinerary_items.', 'Handbook cards are text sections such as key information, teams, rooms, format, prize fund, itinerary, kit/shirt colours, flights/travel, and FAQs.', 'Team kit/colour notes are handbook content and do not replace saved team Colour fields.'] },
    { heading: 'Step-by-step', items: ['Open Handbook.', 'Edit itinerary rows with date, day, time, activity, location, notes, placeholder, and sort order.', 'Remove stale placeholder itinerary items with the delete action.', 'Use Build draft itinerary from tour dates and rounds to add missing round-based itinerary rows. This is not currently automated for all travel/social plans; use manual entry for those.', 'Edit handbook cards by section key/title/body/sort order, then save.'] },
    { heading: 'Troubleshooting', items: ['If Info shows stale placeholder text, edit/delete the handbook section or itinerary item rather than hardcoding public pages.', 'To avoid copying 2025 data into 2026, check selected tour and current public tour before saving.'] },
  ] },
  { id: 'guide-publishing', title: 'Publishing and visibility', summary: 'Understand why Admin data may not be visible publicly.', blocks: [
    { heading: 'Rules', items: ['Public password access only gets a user through the gate; it does not publish private content.', 'Users see content for the current public tour only.', 'Rounds, teams/roster, matches, results, secondary prize results, and handbook/itinerary content must be published or otherwise visible according to their own controls.'] },
  ...
  { id: 'guide-archive', title: 'Archiving and next year setup', summary: 'Finish a tour, preserve history, and prepare next year.', blocks: [
    { heading: 'Step-by-step', items: ['In Tour setup, set a finished tour to complete when the event is done.', 'Use archived for older tours that should remain historical.', 'Do not delete completed courses, matches, results, rosters, handbook, betting or player snapshots just to start a new year.', 'Create next year’s tour with Create next tour, copy/review its course guides, then build rounds, rosters, Info and Bet Punto against that new selected tour.'] },
    { heading: 'What remains / resets', items: ['Historical courses, teams, rounds, matches, results, handbook, prize results, betting and tour-specific player profiles remain with that tour.', 'The next tour starts with its own courses and Bet Punto records; only reusable guide data is copied deliberately.', 'Tour-specific snapshots protect historic tours from later edits.'] },
  ] },
...
export function Admin() {
  ...
  const applyFormatTemplate2026 = () => {
    if (!selectedTour) return;
    if (!window.confirm('Apply the agreed 2026 format template to this tour? This updates/creates planned rounds and safe placeholder itinerary rows, but does not delete matches or results.')) return;
